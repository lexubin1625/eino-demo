...
require (
	...
	github.com/cloudwego/eino-ext/components/embedding/openai v0.0.0-20251125094026-d36991a29748
	github.com/cloudwego/eino-ext/components/model/openai v0.1.5
	github.com/cloudwego/eino-ext/components/retriever/es8 v0.0.0-20251126024534-134208f85815
